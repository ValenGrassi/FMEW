...
export const Campana = () => {
    ...
    return (
        <div class="relative grid px-4 py-1.5 justify-center">
            {/* Icono campana */}
            <a href="#noticias" onClick={(e) => {
                    setHasNews(false) // Por ejemplo, quitar la notificación al click
                }}>
                <svg class="invert cursor-pointer" xmlns="..." width="25" height="25" viewBox="0 0 64 64">
            ...
            {/* Notificación roja */}
            {hasNews && (
                <span class="absolute top-1.5 right-3 w-2.5 h-2.5 bg-red-500 rounded-full"></span>
            )}
        </div>
    )
}
